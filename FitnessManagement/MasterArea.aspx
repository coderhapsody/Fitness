<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="MasterArea.aspx.cs" Inherits="MasterArea" StyleSheetTheme="Workspace" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:SqlDataSource ID="sdsMaster" runat="server" 
                            ...
                            SelectCommand="proc_GetAllAreas" SelectCommandType="StoredProcedure">
                        </asp:SqlDataSource>
                    </td>
                </tr>
            </table>
