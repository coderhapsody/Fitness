<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportSummaryInstructor.aspx.cs" Inherits="ReportSummaryInstructor" %>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=SummaryInstructor&BranchID=' + id + '&Month=' + month + '&Year=' + year);
