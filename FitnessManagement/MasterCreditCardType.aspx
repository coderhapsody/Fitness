<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="MasterCreditCardType.aspx.cs" Inherits="MasterCreditCardType" StyleSheetTheme="Workspace" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:SqlDataSource ID="sdsMaster" runat="server" 
                            ...
                            SelectCommand="proc_GetAllCreditCardTypes" SelectCommandType="StoredProcedure">
                        </asp:SqlDataSource>
                    </td>
                </tr>
            </table>
