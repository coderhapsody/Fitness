<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportSummaryMembershipType.aspx.cs" Inherits="ReportSummaryMembershipType" %>

<asp:Content ID="Content3" ContentPlaceHolderID="cphMainTitle" Runat="Server">
    Sales Membership Type
</asp:Content>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=SummaryMembershipTypeUnit&BranchID=' + id + '&Month=' + month + '&Year=' + year);
