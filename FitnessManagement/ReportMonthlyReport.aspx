<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportMonthlyReport.aspx.cs" Inherits="ReportMonthlyReport" StylesheetTheme="Workspace" %>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=MonthlyReport&BranchID=' + id + '&Month=' + month + '&Year=' + year);
