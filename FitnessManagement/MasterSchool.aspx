<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="MasterSchool.aspx.cs" Inherits="MasterSchool" StylesheetTheme="Workspace" %>
        ...
        <asp:View ID="viwRead" runat="server">
            <table class="fullwidth">
                <tr>
                    ...
                    <td><asp:TextBox ID="txtFindSchoolName" runat="server" CssClass="flat" /> </td>
                </tr>
                <tr>
                    <td></td>
                    <td><asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="button" OnClick="btnSearch_Click" /> </td>
                </tr>
            </table>
            <table class="style1">
                <tr>
                ...
                <tr>
                    <td>
                        ...
                        <asp:SqlDataSource ID="sdsMaster" runat="server" 
                            ...
                            SelectCommand="proc_GetAllSchools" SelectCommandType="StoredProcedure">
                            <SelectParameters>
            ...
            <table class="style1">
                <tr>
                    ...
                    <td class="style3">
                        :</td>
                    <td>
                        <asp:TextBox id="txtName" runat="server" CssClass="textbox" Width="300px" MaxLength="100" ValidationGroup="AddEdit" />
                        <asp:RequiredFieldValidator ID="rqvDescription" runat="server" ControlToValidate="txtName" EnableViewState="false" ErrorMessage="<b>School Name</b> must be specified" ValidationGroup="AddEdit" CssClass="errorMessage" SetFocusOnError="true" />
                     </td>
                </tr>           
                <tr>
                    <td class="style2">
