<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="MasterCustomerStatus.aspx.cs" Inherits="MasterCustomerStatus" StyleSheetTheme="Workspace" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gvwMaster" runat="server" SkinID="GridViewDefaultSkin" 
                            Width="300px" AutoGenerateColumns="False" DataSourceID="sdsMaster" 
                        ...
                        <asp:SqlDataSource ID="sdsMaster" runat="server" 
                            ...
                            SelectCommand="proc_GetAllCustomerStatus" SelectCommandType="StoredProcedure">
                        </asp:SqlDataSource>
                    </td>
                </tr>
            </table>
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td class="style3">
                        :</td>
                    <td>
                        Foreground: <cc1:ColorPicker ID="colColor" runat="server"  />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Background: <cc1:ColorPicker ID="colBgColor" runat="server"  />
                    </td>
                </tr>
                <tr>
                    <td class="style2">
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="cphHead">
    ...
    <script>
        $(function () {
            $("input[name$='colColor']").addClass("textbox");
        });
    </script>
</asp:Content>
