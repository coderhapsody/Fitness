...
public partial class ReportClassAttendanceRegular : System.Web.UI.Page
{
    ...
    protected void gvwSchedule_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hypViewReport.Attributes.Add("onclick",
                "showSimplePopUp('PrintPreview.aspx?RDL=ClassAttendanceRegular&ClassRunningID="+ e.Row.Cells[0].Text + "');");
        }
    }
}