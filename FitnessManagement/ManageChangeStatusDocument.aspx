<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true"
    CodeFile="ManageChangeStatusDocument.aspx.cs" Inherits="ManageChangeStatusDocument" StylesheetTheme="Workspace" %>
            ...
            <table class="ui-accordion">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                        <asp:Button ID="btnVoid" runat="server" CausesValidation="false" Visible="false"
