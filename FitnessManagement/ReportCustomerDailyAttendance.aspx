<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportCustomerDailyAttendance.aspx.cs" Inherits="ReportCustomerDailyAttendance" %>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=CustomerDailyAttendance&BranchID=' + id + '&Month=' + month + '&Year=' + year);
