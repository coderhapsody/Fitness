<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportDetailInstructor.aspx.cs" Inherits="ReportDetailInstructor " %>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=DetailInstructor&BranchID=' + id + '&Month=' + month + '&Year=' + year);
