<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="MasterDocumentType.aspx.cs" Inherits="MasterDocumentType" StyleSheetTheme="Workspace" %>
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td class="style3">
                        :</td>
                    <td>
                        <asp:DropDownList ID="ddlCustomerStatus" runat="server" CssClass="dropdown">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
