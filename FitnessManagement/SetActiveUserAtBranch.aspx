<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="SetActiveUserAtBranch.aspx.cs" Inherits="SetActiveUserAtBranch" StyleSheetTheme="Workspace" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphMainContent" Runat="Server">
            ...
            <td>
                <table class="style1">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlUser" runat="server" CssClass="dropdown" AutoPostBack="True"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function pageLoad() {
            $get('<%= btnSave.ClientID %>').disabled = $get('<%= ddlUser.ClientID %>').selectedIndex == 0;
