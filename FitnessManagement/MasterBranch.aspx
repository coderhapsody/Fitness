<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="MasterBranch.aspx.cs" Inherits="MasterBranch" StyleSheetTheme="Workspace" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:SqlDataSource ID="sdsMaster" runat="server" 
                            ...
                            SelectCommand="proc_GetAllBranches" SelectCommandType="StoredProcedure">
                        </asp:SqlDataSource>
                    </td>
                </tr>
            </table>
            ...
            <table class="style1">
                <tr>
                    ...
                    <td class="style3">
                        :</td>
                    <td>
                        <asp:TextBox id="txtName" runat="server" CssClass="textbox" Width="300px" MaxLength="50" ValidationGroup="AddEdit" />
                ...
                <tr>
                    ...
                    <td class="style3">
                        :</td>
                    <td>
                        <asp:TextBox id="txtCode" runat="server" CssClass="textbox" Width="30px" 
                            MaxLength="3" ValidationGroup="AddEdit" />
                ...
                <tr>
                    ...
                    <td class="style3">
                        :</td>
                    <td>
                        <asp:TextBox id="txtAddress" runat="server" CssClass="textbox" Width="500px" MaxLength="100"  ValidationGroup="AddEdit"  /></td>
                </tr>
                <tr>
                    <td class="style2">
                        Email</td>
                    <td class="style3">
                        :</td>
                    <td>
                        <asp:TextBox id="txtEmail" runat="server" CssClass="textbox" Width="200px" MaxLength="50" ValidationGroup="AddEdit" />
                ...
                <tr>
                    ...
                    <td class="style3">
                        :</td>
                    <td>
                        <asp:TextBox id="txtPhone" runat="server" CssClass="textbox" Width="100px" MaxLength="20" ValidationGroup="AddEdit" /></td>
                </tr>
                <tr>
                    <td class="style2">
                        Merchant Code</td>
                    <td class="style3">
                        :</td>
                    <td>
                        <asp:TextBox id="txtMerchantCode" runat="server" CssClass="textbox" Width="100px" MaxLength="20" ValidationGroup="AddEdit" /></td>
                </tr>
                <tr>
                    <td class="style2">
                        &nbsp;</td>
