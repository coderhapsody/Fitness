<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportMonthlyInstallment.aspx.cs" Inherits="ReportMonthlyInstallment" %>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=MonthlyInstallment&BranchID=' + id + '&Month=' + month + '&Year=' + year);
