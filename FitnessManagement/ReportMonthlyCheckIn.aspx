<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportMonthlyCheckIn.aspx.cs" Inherits="ReportMonthlyCheckIn" StylesheetTheme="Workspace" %>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=MonthlyCheckIn&BranchID=' + id + '&Month=' + month + '&Year=' + year);
