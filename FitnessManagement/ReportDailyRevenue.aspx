<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportDailyRevenue.aspx.cs" Inherits="ReportDailyRevenue" StylesheetTheme="Workspace" %>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=DailyRevenue&BranchID=' + id + '&Date=' + date.format("YYYY-MM-DD"));
