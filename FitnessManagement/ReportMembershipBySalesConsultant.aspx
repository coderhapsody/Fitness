<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkspace.master" AutoEventWireup="true" CodeFile="ReportMembershipBySalesConsultant.aspx.cs" Inherits="ReportMembershipBySalesConsultant" StylesheetTheme="Workspace" %>

<asp:Content ID="Content3" ContentPlaceHolderID="cphMainTitle" Runat="Server">
    Membership By Sales Consultant        
</asp:Content>
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= btnViewReport.ClientID %>").click(function () {
                ...
                showSimplePopUp('PrintPreview.aspx?RDL=MembershipBySalesConsultant&BranchID=' + id + '&Month=' + month + '&Year=' + year);
